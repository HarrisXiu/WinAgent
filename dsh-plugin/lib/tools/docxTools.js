...
async function writeDocx(savePath, buf) {
    ...
    await fs_1.promises.mkdir(path_1.default.dirname(final), { recursive: true });
...
exports.docxTools = [
    {
        schema: {
            ...
            description: '创建 Word (.docx) 文档，支持标题/段落/列表/表格/分页，以及 Word 原生可编辑数学公式（LaTeX 语法）。' +
        ...
        async run(a) {
            ...
            const final = await writeDocx((0, types_1.str)(a.save_path), buf);
    ...
    },
    {
        schema: {
            ...
            description: '把 Markdown 文本直接转换为 Word (.docx)。支持 # 标题、- / 1. 列表、| 表格 |、$$块级公式$$、$行内公式$、--- 分页符。' +
    ...
    },
    {
        schema: {
            ...
            description: '数学公式编辑器：把 LaTeX 公式转换为 Word 原生公式 OMML XML 并校验语法。' +
        ...
        async run(a) {
            const latex = (0, types_1.str)(a.latex);
            if (!latex.trim())
                throw new Error('latex 为空');
            const omml = (0, DocxBuilder_1.latexToOmml)(latex, !(0, types_1.bool)(a.inline, false));
